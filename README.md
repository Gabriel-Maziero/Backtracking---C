...
Funcionalidades
Definição de rotas entre pontos (nós)
Busca de caminhos utilizando recursão
Possível verificação de caminhos válidos
...
Praticar recursão
Entender busca em grafos
Melhorar a lógica de programação em C
